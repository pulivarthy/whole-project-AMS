<%@ Page Title="" Language="C#" MasterPageFile="~/Commonpg.master" AutoEventWireup="true" CodeBehind="CustomerReg.aspx.cs" Inherits="AMC.CustomerReg" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row form-group">
            ...
            <div class="col-sm-4">
               <asp:RequiredFieldValidator ID="RequiredFieldValidatorDob" runat="server" ErrorMessage="Enter Date of birth" ControlToValidate="txtDob" ></asp:RequiredFieldValidator>
                <asp:RangeValidator ID="RangeValidatorDob" runat="server" ErrorMessage="Invalid Format" MinimumValue="01/01/1910"  ControlToValidate="txtDob" Type="Date"></asp:RangeValidator>
            </div>
            <div class="col-sm-1"></div>
        </div>
    ...
    <div class="row form-group">
            ...
            <div class="col-sm-4">
                ...
                <asp:RangeValidator ID="RangeValidatorDoj" runat="server" ErrorMessage="Invalid Format" MinimumValue="01/01/1910" ControlToValidate="txtDoj" Type="Date"></asp:RangeValidator>
            </div>
            <div class="col-sm-1"></div>
        </div>
    <div class="row form-group">
